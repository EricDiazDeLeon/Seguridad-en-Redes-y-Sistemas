...
## Solución  
```bash
primero inspeccionamos la pagina y encontramos este codigo:
...
Despues meti el codigo en js beautifier para que fuera mas legible
< script type = "text/javascript" >
...
en la parte del script se encuentra una funcion que devuelve diferentes respuestas de la pagina dependiendo de el codigo introducido, usamos dicha funcion para obtener la FLAG:
...
```
## Notas Adicionales 
La flag es: picoCTF{not_this_again_337115}
el procedimiento de este problema ctf esta en el apartado de solucion (lo puse asi por comodidad).
### Referencias
js beautifier
https://beautifier.io/
