...
## Solución
```bash
kali@KaliEND:~/Downloads/PicoCTF/Exam3erParcial/john_po$ wget https://jupiter.challenges.picoctf.org/static/c882787a19ed5d627eea50  
f318d87ac5/cert  
--2024-11-21 17:39:45--  https://jupiter.challenges.picoctf.org/static/c882787a19ed5d627eea50f318d87ac5/cert  
...
2024-11-21 17:39:45 (10,9 MB/s) - «cert» guardado [725/725]  
  
kali@KaliEND:~/Downloads/PicoCTF/Exam3erParcial/john_po$ ls  
cert  
kali@KaliEND:~/Downloads/PicoCTF/Exam3erParcial/john_po$ file cert    
cert: PEM certificate  
kali@KaliEND:~/Downloads/PicoCTF/Exam3erParcial/john_po$ openssl x509 -in cert -text -noout  
Certificate:  
   Data:  
       Version: 1 (0x0)  
...
```
## Notas Adicionales
despues de obtener el certificado usamos la pagina de factordb para obtener la bandera.
